...
import { BiLike } from "react-icons/bi";
 ...
 //! Fetch events from the server ---------------------------------------------------------------
  ...
  //! Like Functionality --------------------------------------------------------------
    ...
    return (
      <>
      <div className="mt-0 mb-0 flex flex-col bg-black bg-opacity-75">
        <div className="hidden sm:block" >
          <div href="#" className="flex item-center inset-0">
             <img src="../src/assets/eduevent2.jpg" alt="" className="w-full"/>  
          </div>
        </div>
    ...
    {/* FIXME: This is a demo image after completing the create event function delete this */}
              ...
              <div className="m-2 grid gap-2">
                ...
                <div className="flex justify-between items-center my-2 mr-4">
                  ...
                  <div className="text-sm text-primarydark ">Created By: Admin <br/> <span className="font-semibold">{event.owner.toUpperCase()}</span></div>
                </div>
