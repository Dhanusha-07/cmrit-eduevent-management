...
//! Search input ----------------------------------------------------------------
  ...
  return (
    <div>
      <header className='flex flex-row py-2 px-6 sm:px-6 justify-between items-center'>
      {!!user &&(
      <Link to={'/HomePage'}>
          <button 
          ...
          {/* <Link to={'/'} className="flex items-center mb-0 "> */}
            <img src="../src/assets/logo.jpg" alt="" className='w-28 h-15'/>
          {/* </Link> */}
     ...
     {!user && ( 
            <Link to={'/createEvent'}>
              <div className='hidden md:flex flex-col items-center py-1 px-2 rounded text-primary cursor-pointer hover:text-primarydark hover:bg-white hover:shadow-sm shadow-gray-200 hover:transition-shadow duration-1500'>
                <button>
...
{!user && ( 
            <Link to={'/reviews'}>
              <div className='hidden md:flex flex-col items-center py-1 px-2 rounded text-primary cursor-pointer hover:text-primarydark hover:bg-white hover:shadow-sm shadow-gray-200 hover:transition-shadow duration-1500'>
                ...
                <div className='font-bold color-primary text-sm'>Add Review</div>
              </div>  
            </Link>
          )} 
...
{!user && ( 
            <Link to={'/placements'}>
              <div className='hidden md:flex flex-col items-center py-1 px-2 rounded text-primary cursor-pointer hover:text-primarydark hover:bg-white hover:shadow-sm shadow-gray-200 hover:transition-shadow duration-1500'>
                ...
                <div className='font-bold color-primary text-sm'>Placement</div>
              </div>  
            </Link>
          )} 
          <div className='hidden lg:flex gap-5 text-sm'>
          <Link to={'/wallet'}> {/*TODO:Route wallet page after creating it */}
            <div className='flex flex-col items-center py-1 px-3 rounded cursor-pointer hover:text-primarydark hover:bg-white hover:shadow-sm shadow-gray-200 hover:transition-shadow duration-1500'>
