...
export default function LoginPage() {
  ...
  return (
    <div className="fixed top-0 left-0 flex w-full h-full lg:ml-2 px-10 py-10 justify-between place-items-center mt-2 bg-blue-100">
      <div className= "bg-white w-full sm:w-full md:w-1/2 lg:w-1/3 px-7 py-7 rounded-xl justify-center align-middle">
        ...
        <form className="flex flex-col w-auto items-center" onSubmit={handleLogin}>
            <h1 className='px-3 font-extrabold mb-5 text-primarydark text-2xl '>Admin Login</h1>
            ...
            <div className="w-full py-4">
              <button type="submit" className="primary w-full"> Login </button>
            </div>
