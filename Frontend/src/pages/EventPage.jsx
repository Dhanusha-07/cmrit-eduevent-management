...
if (!event) return '';
  return (
    <div className="flex flex-col mx-3 xl:mx-32 md:mx-20 mt-0 mb-5 flex-grow bg-white bg-opacity-75">
       <Link to={'/events'}>
          <button 
     ...
     <div >
        {event.image &&(
          <img src={`${event.image}`} alt="" height="300px" width="1440px" className='rounded object-fill aspect-16:9'/>
        )}
      </div>

      <img src="../src/assets/event1.jpg" alt="" className='rounded object-fill aspect-16:9 h-30 '/> 
      ...
      <div className="flex justify-between mt-8 mx-2">
          ...
          <Link to={'/event/'+event._id+ '/ordersummary'}>
            <button className="primary">Ticket (for your reference)</button>  
          </Link>
      </div>
      <div className="mx-2">
    ...
    <div className="flex justify-center items-center text-2xl mt-5">
      <a href={event.googleFormLink} target="_blank" rel="noopener noreferrer" className="text-primary underline">Google Form Link</a>
    </div>
  )}
      ...
      <div className="mx-2 mt-5 mb-10 text-md md:text-xl font-extrabold">
        Share with friends
