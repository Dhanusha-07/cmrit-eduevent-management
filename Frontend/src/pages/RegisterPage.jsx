  ...
  return (
    ...
    <div className="mainContainer">
      <div className= "hidden lg:flex flex-col right-box ">
        ...
        <div className="flex items-center justify-center text-3xl font-black">Welcome to EduEvent Hub</div>

        <div className="ml-auto w-full max-w-screen-md mt-30 relative">
             <img src="../src/assets/logo.jpg" alt="" className="absolute top-0 left-0 w-20 h-auto" />
             <img src="../src/assets/background.jpg" alt="" className="w-full"/>
         </div>
      ...
      <div className= "bg-blue w-full sm:w-full md:w-1/2 lg:w-1/3 px-7 py-7 rounded-xl justify-center align-middle ">
        ...
        <form className="flex flex-col w-auto items-center" onSubmit={registerUser}>
            ...
            <div className="w-full py-4">
             {/* Call registerUser function onClick */}
              <button type="submit" className="primary w-full" onClick={registerUser}> Create Account </button>
            </div>
            ...
            <div className="container2">
              ...
              <div className="w-full h-full p-1">
                <Link to={'/admin'}>
                  <button type="submit" className="text-white cursor-pointer rounded w-full h-full bg-primary font-bold" > Admin</button>
                </Link>
              </div>
            </div>
